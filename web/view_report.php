            ...
            $(function () {
                $(document).on("click", "#ok", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "test.php",
                        data: {"user_id": userid, "start": strDateTime, "end": endDateTime, "type": "general"},
                        success: function (data) {
                            var opts = $.parseJSON(data);
                            if (opts.report !== null) {
                                $('#report').html(opts.report).css("color", "black");
                ...
                $(document).on("click", "#export", function () {
                    ...
                    var end = array[1];
                    var type = "general";
                    window.location = "http://Localhost/Reporting/web/excel_export.php?start=" + start + "&end=" + end + "&type=" + type;
