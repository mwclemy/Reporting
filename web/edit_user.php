...
<?php $user= find_user_by_id(filter_input(INPUT_GET, "id"));?>
    ...
    <body>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" id="loginForm" method="POST" action="edit_user.php?id=<?php echo $user["user_id"] ?>">
										<div class="form-group">
                                                <label>New Username</label>
                                                <input id="username" class="form-control" name="username" value="<?php echo $user["username"]?>" type="text">
                                                <div id="uname"> </div>
                                            </div>
                                            <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            $("#loginForm").submit(function (e) {
                ...
                if (password.length < 1 || repassword.length < 1 || username.length < 1) {
                    ...
                    $("#repass").html(repassword.length < 1 ? "Password required" : "").css("color", "red");
					 $("#uname").html(username.length < 1 ? "Username required" : "").css("color", "red");
                    e.preventDefault();
                }
