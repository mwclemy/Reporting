                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <br/><div id="request"> You  have  <strong> <span id="requestnot">  </span> </strong> New Requests <a href="view_requests.php" >View All Requests</a></div> <br/>
                                        <div id="task"> You  have   <strong> <span id="tasknot">  </span> </strong>  New  Tasks <a href="view_tasks.php" >View All  Tasks</a> </div> <br/>
                                    </div>
