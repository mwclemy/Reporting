    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Access Matrix</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                $('.check').click(function () {
                    ...
                    if ($(this).is(':checked')) {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: {
                                "update": 'checked', "userid": userid, "menuid": menuid
                            }
                        });
                    }
                    else {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: {
                                update: 'unchecked', "userid": userid, "menuid": menuid
                            }
                        });
                    }
                });
                $('#save').click(function () {
                    $('#table').html("<div class=\"alert alert-success\">Changes have been saved, return to the <a href=\"user_permissions.php\">Access Matrix</a></di>");
                });
