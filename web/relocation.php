    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"> Relocate Connection </h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
        ...
        <script type="text/javascript">
            ...
            $(document).on("click", ".submit", function () {
                ...
                var newloc = $('#' + connection + ' .nloc').val();
                var comment = $('#' + connection + ' .comm').val();
                if (newloc === "") {
                    $('#' + connection + ' .nl').html("Enter Location").css("color", "red");
                }
                else {
                    $('#' + connection + ' .nl').html("");
                    ...
                    $.ajax({
                        type: "POST",
                        url: "request_processing.php?request_type=Relocate",
                        data: {"connection_id": connectionid, "request_id": requestid, "customer_id": customerid, "newloc": newloc, "comm": comment}
                        ,
                        success: function (data) {
                            var opts = $.parseJSON(data);
                            if (opts === true) {
