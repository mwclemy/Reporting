    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"> Upgrade/Downgrade Connection </h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
        ...
        <script type="text/javascript">
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (opts.connections === null) {
                                ...
                                $("#notfound").html("");
                                $("#contable").html(opts.connections).css("color", "black");;
                            }
            ...
            $(document).on("click", ".submit", function () {
                ...
                var newpack = $('#' + connection + ' .npack').val();
                var comment = $('#' + connection + ' .comm').val();
                if (newpack === "") {
                    $('#' + connection + ' .np').html("Enter Package").css("color", "red");
                }
                else {
                    $('#' + connection + ' .np').html("");
                    ...
                    $.ajax({
                        type: "POST",
                        url: "request_processing.php?request_type=Upgrade",
                        data: {"connection_id": connectionid, "request_id": requestid, "customer_id": customerid, "newpack": newpack, "comm": comment}
                        ,
                        success: function (data) {
                            var opts = $.parseJSON(data);
                            if (opts === true) {
